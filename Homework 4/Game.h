...
public:
    ...
    */
    ...
    /**
     * Find the coordinate to move to given a vector of possible coordinates. The coordinates
     * in the given list are closer to the target than the current position. Function finds
     * the one that is the closest. If there are 2 coordinates that are equally close to the
     * target, then the horizontal move is preferred.
     * @param possibleCoordinates vector of possible move coordinates
     * @param currentPos current position
     * @param target target coordinate
     * @return Coordinate to move to. {-1, -1} if none possible.
     */
    static Coordinate findMoveCoordinate(std::vector<Coordinate>& possibleCoordinates,
